    ...
    <PageTransition>
      ...
      <section className="bg-dark-base py-10 md:py-16">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <AnimatedSection>
            <div className="card-dark p-5 md:p-8 border-l-4 border-teal-400/50">
              <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4 md:mb-5">
              ...
              <p className="text-slate-400 leading-relaxed text-sm md:text-base mb-4 md:mb-5">
      ...
      {/* ── LEADERSHIP TEAM ───────────────────────────────────── */}
      <section className="bg-dark-base py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            {BOARD_MEMBERS.map((member) => (
              <motion.div
                ...
                className="card-dark p-5 md:p-7 flex flex-col items-center text-center w-[calc(50%-12px)] sm:w-56 lg:w-52 xl:w-56 cursor-default"
              >
                {/* Avatar */}
                <div className="relative mb-3 md:mb-5">
                  <div className="w-20 h-20 md:w-28 md:h-28 rounded-full ring-2 ring-teal-400/30 ring-offset-2 ring-offset-[#0D1117] overflow-hidden">
                    <img
                      src={member.photo}
                      alt={member.name}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            ...
            <AnimatedSection direction="left">
              <div className="glass p-5 md:p-8 h-full">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Our Vision</h3>
            ...
            <AnimatedSection direction="right">
              <div className="glass p-5 md:p-8 h-full">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Our Mission</h3>
                <p className="text-slate-400 leading-relaxed">
